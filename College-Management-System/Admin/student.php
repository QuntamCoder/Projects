...
// *****************************************Images upload code end here********************************************************** 
 		...
 		$query="Insert into student_info(roll_no,first_name,middle_name,last_name,father_name,email,mobile_no,course_code,session,prospectus_issued,prospectus_amount,form_b,applicant_status,application_status,cnic,dob,gender,permanent_address,current_address,place_of_birth,matric_complition_date,matric_awarded_date,fa_complition_date,fa_awarded_date,ba_complition_date,ba_awarded_date)values('$roll_no','$first_name','$middle_name','$last_name','$father_name','$email','$mobile_no','$course_code','$session','$prospectus_issued','$prospectus_amount','$form_b','$applicant_status','$application_status','$cnic','$dob','$gender','$permanent_address','$current_address','$place_of_birth','$matric_complition_date','$matric_awarded_date','$fa_complition_date','$fa_awarded_date','$ba_complition_date','$ba_awarded_date')";
					   ...
					   <div class="modal-dialog modal-lg">
						    <div class="modal-content">
							    <div class="modal-header bg-info text-white">
							        <h4 class="modal-title text-center">Addmission Form</h4> -->
										...
										<div class="row mt-3">
								  		...
								  		<div class="row">
											...
											<div class="col-md-4">
												<div class="form-group">
												    ...
												    <input type="text" name="cnic" data-inputmask="'mask': '9999-9999-9999'" placeholder="XXXXX-XXXXXXX-X" class="form-control">
											    </div>
											</div>
								  		</div>
								  		<div class="row">
											...
											<div class="col-md-4">
												<div class="form-group">
												    ...
												    <input type="tel" name="mobile_no" size="9" class="form-control" required>
											    </div>
											</div>
											<div class="col-md-4">
												<div class="form-group">
										 ...
										 <!-- <div class="col-md-4">
								  		...
								  		<div class="modal-main">
											 <br><br><br><br><hr><br> <input type="submit" class="btn btn-info" name="btn_save" value="Save Data">
					...
					<div class="col-md-12 ml-2">
						<section class="mt-3">
							...
							<table class="w-100 table-elements mb-5 table-three-tr text-center" cellpadding="10">
								...
								<?php 
								$query="select first_name,middle_name,admission_date,last_name,current_address,session,roll_no,form_b ,course_code from student_info";
								$run=mysqli_query($con,$query);
								while($row=mysqli_fetch_array($run)) {?>
									<tr>
