...
// *****************************************Images upload code end here********************************************************** 
   ...
   $query="Insert into teacher_info(first_name,middle_name,last_name,email,phone_no,teacher_status,application_status,cnic,dob,other_phone,gender,permanent_address,current_address,place_of_birth,fa_complition_date,fa_awarded_date,ba_complition_date,ba_awarded_date,ma_complition_date,ma_awarded_date,hire_date)values('$first_name','$middle_name','$last_name','$email','$phone_no','$teacher_status','$application_status','$cnic','$dob','$other_phone','$gender','$permanent_address','$current_address','$place_of_birth','$fa_complition_date','$fa_awarded_date','$ba_complition_date','$ba_awarded_date','$ma_complition_date','$ma_awarded_date','$date')";
							...
							<div class="modal-dialog modal-lg">
								<div class="modal-content"> -->
									<!-- <div class="modal-header bg-info text-white"> -->
										<h1 class="modal-title text-center">Add New Teacher</h1>
									</div>
											...
											<div class="row">
												...
												<div class="col-md-4">
													<div class="formp">
														...
														<input type="tel" name="phone_no" size="9" class="form-control"placeholder="Enter Mobile Number">
													</div>
												</div>
												<div class="col-md-4">
													<div class="formp">
