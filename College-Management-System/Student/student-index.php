								...
								<div class="collapse show mt-2" id="collapseOne">
									<table class="w-100 table-elements table-two-tr"cellpadding="2">
										...
										<?php $roll_no=$_SESSION['LoginStudent'];
											...
											// $query="select subject_code,subject_name,semester,credit_hours, roll_no, semester from student_courses sc inner join course_subjects cs on subject_code=subject_code where roll_no='$roll_no' and semester = $semester";
											$run=mysqli_query($con, $query);
											while($row=mysqli_fetch_array($run)) { ?>								
										<tr>
